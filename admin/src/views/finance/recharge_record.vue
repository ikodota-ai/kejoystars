    ...
    <div>
        <el-card class="!border-none" shadow="never">
            ...
            <el-form ref="formRef" class="mb-[-16px] mt-[16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item label="支付方式">
                    <el-select class="w-[200px]" v-model="queryParams.pay_way">
                ...
                <el-form-item label="支付状态">
                    <el-select class="w-[200px]" v-model="queryParams.pay_status">
                        <el-option label="全部" value />
                ...
                <el-form-item>
                    ...
                    <el-button type="warning" @click="handleAdd">充值</el-button>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <el-table size="large" v-loading="pager.loading" :data="pager.lists">
                ...
                <el-table-column label="支付方式" prop="payWayText" min-width="100" />
...
import { ref } from 'vue'
import { rechargeLists, refund, add } from '@/api/finance'
import { usePaging } from '@/hooks/usePaging'
import feedback from '@/utils/feedback'
import EditPopup from './recharge_edit.vue'
...
const handleAdd = async() => {console.log("logg")
    showEdit.value = true
    await nextTick()
