...
public class ArticleController {
    ...
    public AjaxResult<Object> add(@Validated @RequestBody ArticleCreateValidate createValidate) {
        Map<String, Object> movies = new HashMap<String, Object>(){{
            put("id", createValidate.getMovieId());
            put("name", createValidate.getMovieName());
        }};
        createValidate.setMovies(JSONObject.toJSONString(movies));
    ...
    public AjaxResult<Object> edit(@Validated @RequestBody ArticleUpdateValidate updateValidate) {
        Map<String, Object> movies = new HashMap<String, Object>(){{
            put("id", updateValidate.getMovieId());
            put("name", updateValidate.getMovieName());
        }};
        updateValidate.setMovies(JSONObject.toJSONString(movies));
