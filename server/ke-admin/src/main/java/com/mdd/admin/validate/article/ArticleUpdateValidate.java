...
//    @IDMust(message = "cid参数必传且需大于0")
    ...
    @ApiModelProperty(value = "cp编号", required = true)
...
//    @IDMust(message = "未找到关联影视！")
    @ApiModelProperty(value = "关联影视编号", required = true)
    private Integer movieId;

//    @Length(min = 1, max = 200, message = "请输入关联影视！")
    @ApiModelProperty(value = "关联影视", required = true)
    ...
    @DecimalMin(value = "0", message = "发布时间")
