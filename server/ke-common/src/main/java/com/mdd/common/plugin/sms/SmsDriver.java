...
import com.mdd.common.plugin.sms.engine.CxlnkSms;
    ...
    public void sendSms() {
        ...
        switch (this.engine) {
            ...
            case "tencent":
                ...
                break;
            case "cxlnk":
                CxlnkSms cxlnkSms = new CxlnkSms(this.config);
                results = cxlnkSms.setMobile(this.mobile)
                        .setTemplateId(this.templateCode)
                        .setTemplateParams(this.templateParam.get("code"))
                        .send();
                sendResult = cxlnkSms.getSendResult();
                break;
            default:
