...
public class TimeUtils {
    ...
    public static Date toUTC(long time) {
        //转换成utc时区时间
        TimeZone tz = TimeZone.getTimeZone("UTC");
        SimpleDateFormat utcFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        utcFormat.setTimeZone(tz);
        String utcTime = utcFormat.format(new Date(time));
        try {
    ...
    public static String formatChinaDate(Date date, String pattern) {
