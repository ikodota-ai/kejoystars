...
import com.mdd.front.ImageAccessInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    @Resource
    ImageAccessInterceptor imageAccessInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(imageAccessInterceptor).addPathPatterns("/uploads/image/**");
    }
